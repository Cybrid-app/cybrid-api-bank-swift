...
public struct InternalCybridAccountBankModel: Codable, JSONEncodable, Hashable {
    ...
    public init(type: TypeBankModel? = nil, guid: String? = nil, createdAt: Date? = nil, assetCode: String? = nil, name: String? = nil, environment: EnvironmentBankModel? = nil, state: StateBankModel? = nil) {
        self.type = type
        self.guid = guid
