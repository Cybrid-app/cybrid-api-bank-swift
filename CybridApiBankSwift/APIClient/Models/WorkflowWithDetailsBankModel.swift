...
public struct WorkflowWithDetailsBankModel: Codable, JSONEncodable, Hashable {
    ...
    public init(guid: String? = nil, customerGuid: String? = nil, type: String? = nil, state: String? = nil, failureCode: String? = nil, createdAt: Date? = nil, updatedAt: Date? = nil, plaidLinkToken: String? = nil) {
        self.guid = guid
