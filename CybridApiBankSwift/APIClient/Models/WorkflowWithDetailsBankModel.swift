...
public struct WorkflowWithDetailsBankModel: Codable, JSONEncodable, Hashable {
    ...
    public init(guid: String? = nil, customerGuid: String? = nil, type: TypeBankModel? = nil, state: StateBankModel? = nil, failureCode: String? = nil, createdAt: Date? = nil, plaidLinkToken: String? = nil) {
        self.guid = guid
