...
public struct IdentificationNumberBankModel: Codable, JSONEncodable, Hashable {
    ...
    /** The source of the identification number; one of drivers_license, passport, passport_card, visa, residence_card, social_security_number, tax_identification_number, identification_card, work_permit, indigenous_document_number, national_identification_number, employer_identification_number, or business_registration_number. */
    ...
    public init(type: String, issuingCountryCode: String?, identificationNumber: String, issuingSubdivision: String? = nil) {
        self.type = type
