...
// We reverted the change of CybridApiBankSwiftAPI to CybridApiBankSwift introduced in https://github.com/OpenAPITools/openapi-generator/pull/9624
...
@available(*, deprecated, renamed: "CybridApiBankSwiftAPI")
...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:]) {
        ...
        addHeaders(CybridApiBankSwiftAPI.customHeaders)
    }
    ...
    @discardableResult
    open func execute(_ apiResponseQueue: DispatchQueue = CybridApiBankSwiftAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
        return requestTask
    }
    ...
    open func addCredential() -> Self {
        credential = CybridApiBankSwiftAPI.credential
        return self
    }
}
