...
open class DepositBankAccountsAPI {
     ...
     */
    @discardableResult
    open class func deleteDepositBankAccount(depositBankAccountGuid: String, apiResponseQueue: DispatchQueue = CybridApiBankSwiftAPI.apiResponseQueue, completion: @escaping ((_ result: Swift.Result<DepositBankAccountBankModel, ErrorResponse>) -> Void)) -> RequestTask {
        return deleteDepositBankAccountWithRequestBuilder(depositBankAccountGuid: depositBankAccountGuid).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(.success(response.body))
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<DepositBankAccountBankModel> 
     */
    open class func deleteDepositBankAccountWithRequestBuilder(depositBankAccountGuid: String) -> RequestBuilder<DepositBankAccountBankModel> {
    ...
    /**
     ...
     - parameter state: (query) Comma separated states to list deposit bank accounts for. (optional)
     ...
     */
    @discardableResult
    open class func listDepositBankAccounts(page: Int? = nil, perPage: Int? = nil, guid: String? = nil, bankGuid: String? = nil, customerGuid: String? = nil, label: String? = nil, uniqueMemoId: String? = nil, type: String? = nil, state: String? = nil, parentDepositBankAccountGuid: String? = nil, apiResponseQueue: DispatchQueue = CybridApiBankSwiftAPI.apiResponseQueue, completion: @escaping ((_ result: Swift.Result<DepositBankAccountListBankModel, ErrorResponse>) -> Void)) -> RequestTask {
        return listDepositBankAccountsWithRequestBuilder(page: page, perPage: perPage, guid: guid, bankGuid: bankGuid, customerGuid: customerGuid, label: label, uniqueMemoId: uniqueMemoId, type: type, state: state, parentDepositBankAccountGuid: parentDepositBankAccountGuid).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(.success(response.body))
            case let .failure(error):
     ...
     */
    open class func listDepositBankAccountsWithRequestBuilder(page: Int? = nil, perPage: Int? = nil, guid: String? = nil, bankGuid: String? = nil, customerGuid: String? = nil, label: String? = nil, uniqueMemoId: String? = nil, type: String? = nil, state: String? = nil, parentDepositBankAccountGuid: String? = nil) -> RequestBuilder<DepositBankAccountListBankModel> {
        let localVariablePath = "/api/deposit_bank_accounts"
        let localVariableURLString = CybridApiBankSwiftAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
