...
let postBankBankModel = PostBank(name: "name_example", type: "type_example", supportedTradingSymbols: ["supportedTradingSymbols_example"], features: ["features_example"], supportedFiatAccountAssets: ["supportedFiatAccountAssets_example"], supportedCountryCodes: ["supportedCountryCodes_example"], routableAccounts: "routableAccounts_example") // PostBankBankModel | 
