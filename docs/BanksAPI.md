...
let postBankBankModel = PostBank(name: "name_example", type: "type_example", supportedTradingSymbols: ["supportedTradingSymbols_example"], supportedSavingsConfiguration: "TODO", features: ["features_example"]) // PostBankBankModel | 
...
let bankGuid = "bankGuid_example" // String | Identifier for the bank.
let patchBankBankModel = PatchBank(name: "name_example", supportedTradingSymbols: ["supportedTradingSymbols_example"], supportedSavingsConfiguration: "TODO") // PatchBankBankModel | 
