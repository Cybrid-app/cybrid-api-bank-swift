...
let postBankBankModel = PostBank(type: "type_example", name: "name_example", supportedTradingSymbols: ["supportedTradingSymbols_example"], supportedPayoutSymbols: [PostSupportedPayoutSymbols(primaryAsset: "primaryAsset_example", counterAsset: "counterAsset_example", countryCode: "countryCode_example", participantsType: "participantsType_example", route: "route_example")], supportedFiatAccountAssets: ["supportedFiatAccountAssets_example"], supportedCountryCodes: ["supportedCountryCodes_example"], features: ["features_example"], corsAllowedOrigins: ["corsAllowedOrigins_example"]) // PostBankBankModel | 
...
let bankGuid = "bankGuid_example" // String | Identifier for the bank.
let patchBankBankModel = PatchBank(name: "name_example", supportedTradingSymbols: ["supportedTradingSymbols_example"], supportedPayoutSymbols: [PostSupportedPayoutSymbols(primaryAsset: "primaryAsset_example", counterAsset: "counterAsset_example", countryCode: "countryCode_example", participantsType: "participantsType_example", route: "route_example")], corsAllowedOrigins: ["corsAllowedOrigins_example"]) // PatchBankBankModel | 
