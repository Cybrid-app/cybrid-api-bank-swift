...
let postPlanBankModel = PostPlan(type: "type_example", bankGuid: "bankGuid_example", customerGuid: "customerGuid_example", sourceAccount: PostPlan_source_account(guid: "guid_example", amount: 123, paymentRail: "paymentRail_example"), destinationAccount: PostPlan_destination_account(guid: "guid_example", amount: 123, paymentRail: "paymentRail_example"), intermediateAccounts: [PostPlan_intermediate_accounts_inner(guid: "guid_example")], travelRuleInfo: PostPlan_travel_rule_info(ultimateOriginatingPartyGuid: "ultimateOriginatingPartyGuid_example", ultimateReceivingPartyGuid: "ultimateReceivingPartyGuid_example"), purposeOfTransaction: "purposeOfTransaction_example", labels: ["labels_example"], supportingDocuments: [PostSupportingDocument(type: "type_example", fileGuids: ["fileGuids_example"], documentReferenceNumber: "documentReferenceNumber_example")]) // PostPlanBankModel | 
