...
**accountDesignation** | **String** | Account designation for India IFSC and UPI accounts (NRE or NRO). Defaults to NRE when omitted. Optional when payment_rail is IFSC or payment_rail is UPI. | [optional] 
