...
let postQuoteBankModel = PostQuote(productType: "productType_example", customerGuid: "customerGuid_example", symbol: "symbol_example", side: "side_example", receiveAmount: 123, deliverAmount: 123) // PostQuoteBankModel | 
